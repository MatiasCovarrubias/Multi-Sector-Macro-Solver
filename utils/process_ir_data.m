...
%         Row 29: utility_intratemp_ir (level deviation from SS)
    ...
    utility_intratemp_ir = dynare_simul(idx.utility_intratemp, :) - utility_intratemp_ss;
    ...
    irs = [A_ir; C_ir; I_ir; Cj_ir; Pj_ir; Ioutj_ir; Moutj_ir; ...
           ...
           Kj_ir; GDP_ir; Pmj_client_ir; gammaij_client_ir; L_agg_ir; K_agg_ir; utility_intratemp_ir];

    %% Full sectoral vectors for Python-side fixed-price aggregation
    pol_c    = (idx.c(1):idx.c(2))       - idx.ss_offset;
    pol_l    = (idx.l(1):idx.l(2))       - idx.ss_offset;
    ...
    sectoral.L_all    = dynare_simul(idx.l(1):idx.l(2), :)       - ps(pol_l);
    ...
    sectoral.K_all    = dynare_simul(idx.k(1):idx.k(2), :)       - endostates_ss(:);
end
